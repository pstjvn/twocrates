 ...
 * @param {number=} opt_status_id The number of the status from the server.
 * @param {string=} opt_message Optional string representing error message from
 *   te server.
 * @protected
 */
  ...
  switch (error_index) {
    ...
    case Static.STRUCTURED_ERROR:
      ...
      switch (opt_status_id) {
        ...
        case 1001:
          this.noticeDialog_.setText(opt_message);
          k3d.component.PopOver.getInstance().addChild(
              this.noticeDialog_, true);
          k3d.component.PopOver.getInstance().setVisible(true);
          break;
        ...
        default:
          if (goog.DEBUG) {
            console.log('Data structure error:', opt_status_id, opt_message);
          }
      }
      break;
    case Static.RUNTIME:
      switch (opt_status_id) {
        ...
        default:
          if (goog.DEBUG) {
            console.log('Runtime error:', opt_status_id, opt_message);
          }
